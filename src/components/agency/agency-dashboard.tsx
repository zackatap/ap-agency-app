        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            {activeTab === "performance"
              ...
              : activeTab === "scorecard"
                ? "Ad spend (Meta), leads + CPL (GHL), link clicks, CPLC, CTR, plus appts / booking / show / success rates per active & 2nd campaign client. Ads flags cover GHL leads / CPL / spend; Appts/Success flags cover the funnel. Data badges fire when Meta and GHL leads differ by 15% or more."
                : activeTab === "ads"
